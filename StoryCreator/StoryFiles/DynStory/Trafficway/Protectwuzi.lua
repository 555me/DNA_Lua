-- filename: @C:/Pack/Branch/geili11\Content/Script/StoryCreator\StoryFiles\DynStory\Trafficway\Protectwuzi.lua
-- version: lua54
-- line: [0, 0] id: 0
local r0_0 = {
  storyName = "Home",
...
r4_0["1724143150534154"] = {
  key = "1724143150534154",
  type = "QuestFailNode",
  name = "QuestFail",
  pos = {
    x = 2447.360515914292,
    y = 1027.4022779280215,
  },
  propsData = {},
}
local r5_0 = {
  ...
  name = "凯文开车对话",
  pos = {
    x = 1235.9815668202764,
    y = 30.783410138248826,
  },
}
r5_0.propsData = {
  IsNpcNode = false,
...
r4_0["1724143163247567"] = r5_0
r5_0 = {
  key = "1724143163247568",
  type = "TalkNode",
  name = "与凯文对话任务选择",
  pos = {
    x = 1549.1771313364054,
    y = 262.0737327188941,
  },
}
r5_0.propsData = {
...
r4_0["1724143163247568"] = r5_0
r5_0 = {
  key = "17241436682064485",
  type = "TalkNode",
  name = "与士兵对话",
  pos = {
    x = 2118.4348023893217,
    y = 313.454536500875,
  },
}
r5_0.propsData = {
...
r4_0["17241437178385597"] = r5_0
r5_0 = {
  key = "17241437374315980",
  type = "ChangeStaticCreatorNode",
  name = "销毁士兵npc",
  pos = {
    x = 2443.4891502154087,
    y = 122.31323215304893,
  },
}
r5_0.propsData = {
  ActiveEnable = false,
...
r4_0["17241437374315980"] = r5_0
r5_0 = {
  key = "17241437656876420",
  type = "ChangeStaticCreatorNode",
  name = "生成士兵敌人",
  pos = {
    x = 2440.9891502154087,
    y = 292.31323215304894,
  },
}
r5_0.propsData = {
  ActiveEnable = true,
...
r4_0["17241437656876420"] = r5_0
r5_0 = {
  key = "17241438114556928",
  type = "KillMonsterNode",
  name = "击杀怪物",
  pos = {
    x = 2773.4891502154087,
    y = 288.56323215304894,
  },
}
r5_0.propsData = {
  KillMonsterType = "Id",
...
r4_0["17241438528717391"] = r5_0
r5_0 = {
  key = "17241438689357703",
  type = "TalkNode",
  name = "对话获取奖励",
  pos = {
    x = 3360.9348023893226,
    y = 262.258884326962,
  },
}
r5_0.propsData = {
...
r4_0["17241438689357703"] = r5_0
r4_0["17241439073918475"] = {
  key = "17241439073918475",
  type = "DynamicQuestSuccessNode",
  name = "动态任务主动成功",
  pos = {
    x = 3880.4891502154096,
    y = 240.81323215304894,
  },
  propsData = {
    DialogueId = 71002112,
...
r4_0["17241439372409087"] = r5_0
r5_0 = {
  key = "17241439433939323",
  type = "TalkNode",
  name = "去找凯文开车对话",
  pos = {
    x = 2469.4534359296945,
    y = 759.3846607244775,
  },
}
r5_0.propsData = {
...
r4_0["17241439433939323"] = r5_0
r4_0["172414404096810653"] = {
  key = "172414404096810653",
  type = "DynamicQuestSuccessNode",
  name = "动态任务主动成功",
  pos = {
    x = 3637.3891502154097,
    y = 452.06323215304894,
  },
  propsData = {
    DialogueId = 71002118,
    UseTalkFadeOut = false,
...
r4_0["172604455532210101"] = r5_0
r5_0 = {
  key = "17267290106769602",
  type = "TalkNode",
  name = "战斗开车对话",
  pos = {
    x = 2772.4124557434898,
    y = 40.32063338959871,
  },
}
r5_0.propsData = {
...
r4_0["17267290106769602"] = r5_0
r4_0["172672911845211973"] = {
  key = "172672911845211973",
  type = "DynamicQuestFailNode",
  name = "动态任务主动失败",
  pos = {
    x = 1963.8238973910875,
    y = 1045.4373381950907,
  },
  propsData = {
    UseTalkFadeOut = false,
    TalkFadeOutTime = 0,
...
r4_0["17268157180861037"] = r5_0
r5_0 = {
  key = "17273207909072227",
  type = "ChangeStaticCreatorNode",
  name = "销毁门前凯文",
  pos = {
    x = 2724.5238685967424,
    y = 653.9567496543033,
  },
}
r5_0.propsData = {
...
r4_0["17273207909072227"] = r5_0
r5_0 = {
  key = "17273209504194108",
  type = "ChangeStaticCreatorNode",
  name = "生成秽兽",
  pos = {
    x = 2010.7145800591925,
    y = -330.2357969295481,
  },
}
r5_0.propsData = {
...
r4_0["17273209504194108"] = r5_0
r5_0 = {
  key = "17284566997181199",
  type = "ChangeStaticCreatorNode",
  name = "销毁秽兽",
  pos = {
    x = 2082.7732198142417,
    y = 107.6057857457522,
  },
}
r5_0.propsData = {
...
r4_0["17284566997181199"] = r5_0
r4_0["1731395137627609662"] = {
  key = "1731395137627609662",
  type = "WaitOfTimeNode",
  name = "延迟等待",
  pos = {
    x = 2451.3333333333335,
    y = 454.01190476190493,
  },
  propsData = {
    WaitTime = 5,
  },
}
r4_0["176189282569913611726"] = {
