-- filename: @C:/Pack/Branch/geili11\Content/Script/StoryCreator\StoryFiles\SpecialQuest\1201\Shi01Fight.lua
-- version: lua54
-- line: [0, 0] id: 0
local r0_0 = {
  storyName = "Home",
...
r1_0["17627907823105770709"] = r2_0
r2_0 = {
  isStoryNode = true,
...
r1_0["17627907823105770710"] = r2_0
r2_0 = {
  isStoryNode = true,
...
local r4_0 = {}
r4_0["1762686287837535"] = {
  key = "1762686287837535",
  type = "UpdateTaskBarAndTaskMainNode",
  name = "更新任务目标节点",
  pos = {
    x = 1690.6666666666665,
    y = 146.33333333333334,
  },
  propsData = {
...
r4_0["1762686293533700"] = r5_0
r4_0["17626863045651001"] = {
  key = "17626863045651001",
  type = "WaitOfTimeNode",
  name = "延迟等待",
  pos = {
    x = 2098.0340909090905,
    y = 338.45454545454555,
  },
  propsData = {
    WaitTime = 3,
  },
}
r4_0["17627907823105770712"] = {
  key = "17627907823105770712",
  type = "QuestStartNode",
  name = "QuestStart",
  pos = {
    x = 1023.3333333333334,
    y = 340,
  },
  propsData = {
    ModeType = 0,
...
r4_0["17627907823105770713"] = {
  key = "17627907823105770713",
  type = "QuestSuccessNode",
  name = "QuestSuccess",
  pos = {
    x = 2804.5454545454545,
    y = 364.2424242424243,
  },
  propsData = {
    ModeType = 0,
...
r4_0["17627907823105770714"] = {
  key = "17627907823105770714",
  type = "QuestFailNode",
  name = "QuestFail",
  pos = {
    x = 2051.6666666666665,
    y = 716.6666666666666,
  },
  propsData = {},
}
r4_0["17627907823105770715"] = {
  key = "17627907823105770715",
  type = "SpecialQuestSuccessNode",
  name = "成功完成特殊任务",
  pos = {
    x = 2473.5907097288678,
    y = 339.0177717019824,
  },
  propsData = {},
}
r4_0["17627907823105770716"] = {
  key = "17627907823105770716",
  type = "WaitingSpecialQuestFailNode",
  name = "等待特殊任务失败",
  pos = {
    x = 1516.0643939393938,
    y = 628.8423331054913,
  },
  propsData = {},
}
...
r4_0["1764035741860687954"] = r5_0
r4_0["1764035797256688447"] = {
...
r1_0["17627907823105770711"] = r2_0
