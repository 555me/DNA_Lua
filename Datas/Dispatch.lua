-- filename: @C:/Pack/Branch/geili11\Content/Script/Datas\Dispatch.lua
-- version: lua54
-- line: [0, 0] id: 0
local r0_0 = {
  RT_1 = {
...
r4_0[100101] = {
  ...
  DispatchDemand = r0_0.RT_1,
  DispatchId = 100101,
  DispatchPerson = 2,
  DispatchType = "Battle",
  DispatchUIId = 100101,
  PlayerLevel = r0_0.RT_2,
  Rarity = 1,
  RegionId = 1001,
  RewardId = {
    40001,
