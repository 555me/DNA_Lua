-- filename: @C:/Pack/Branch/geili11\Content/Script/Datas\FishingSpot.lua
-- version: lua54
-- line: [0, 0] id: 0
local r0_0 = {
  RT_1 = {
...
local r3_0 = "FishingSpot"
local r4_0 = {
  [101] = {
    FishCountLimit = 999,
    FishId = r0_0.RT_1,
    FishWeight = r0_0.RT_2,
    FishingSpotId = 101,
    FishingSpotName = "测试用钓鱼点",
    LimitDeviation = 0,
    RegionPointId = 2814,
    ReplenishDay = 1,
    ShowFishId = r0_0.RT_3,
    ShowInFishMap = false,
    WaterType = 1,
  },
  [10010101] = {
