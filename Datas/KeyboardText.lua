-- filename: @C:/Pack/Branch/geili11\Content/Script/Datas\KeyboardText.lua
-- version: lua54
-- line: [0, 0] id: 0
return ((DataMgr and {}).ReadOnly and function(r0_1, r1_1)
  ...
  MiddleMouseButton = {
    ...
    KeyImgHeight = 48,
    KeyImgWidth = 48,
    KeyText = "MiddleMouseButton",
  },
  MouseScrollDown = {
    Key = "MouseScrollDown",
    KeyImgHeight = 48,
    KeyImgWidth = 48,
    KeyText = "MouseScrollDown",
  },
  MouseScrollUp = {
    Key = "MouseScrollUp",
    KeyImgHeight = 48,
    KeyImgWidth = 48,
    KeyText = "MouseScrollUp",
  },
  Mouse_Button = {
    Key = "Mouse_Button",
    KeyImgHeight = 48,
    KeyImgWidth = 48,
    KeyText = "Mouse_Button",
  },
  Multiply = {
    Key = "Multiply",
    KeyImgHeight = 32,
  ...
  RightBracket = {
    ...
    KeyImgHeight = 32,
    KeyImgWidth = 32,
    KeyText = "RightBracket",
  },
  RightControl = {
    Key = "RightControl",
    KeyImgHeight = 32,
    KeyImgWidth = 66,
    KeyText = "RightControl",
  },
  RightMouseButton = {
