-- filename: @C:/Pack/Branch/geili11\Content/Script/Datas\StoryVariable.lua
-- version: lua54
-- line: [0, 0] id: 0
return ((DataMgr and {}).ReadOnly and function(r0_1, r1_1)
  ...
  FeinaDay04BackCity01 = {
    IsGlobal = true,
    VarName = "FeinaDay04BackCity01",
  },
  FeinaDay04BackCity02 = {
    IsGlobal = true,
  ...
  TestVar2 = {
    IsGlobal = true,
    OnChangedFunctionName = "OnChanged_TestVar2",
    VarName = "TestVar2",
  },
  TestVar3 = {
    QuestChainId = 100101,
