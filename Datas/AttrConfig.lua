...
return ((DataMgr and {}).ReadOnly and function(r0_1, r1_1)
  ...
  AttackRange_Bullet = {
    ...
    Name = "Attr_AttackRange_Bullet_Name",
    NumCorrect = 0.01,
    ShowInInspector = true,
    SortIndex1 = 24,
    SortIndex2 = 24,
  ...
  AttackSpeed_FallAttack = {
    ...
    Name = "Attr_AttackSpeed_FallAttack_Name",
    ShowInInspector = true,
    SortIndex1 = 20.4,
    SortIndex2 = 20.4,
    SortIndex3 = 20.4,
  ...
  AttackSpeed_HeavyAttack = {
    ...
    Name = "Attr_AttackSpeed_HeavyAttack_Name",
    ShowInInspector = true,
    SortIndex1 = 20.2,
    SortIndex2 = 20.2,
    SortIndex3 = 20.2,
  ...
  AttackSpeed_Normal = {
    ...
    Id = "AttackSpeed_Normal",
    Name = "Attr_AttackSpeed_Name",
    ShowInInspector = true,
    SortIndex1 = 20,
    SortIndex2 = 20,
    SortIndex3 = 20,
  ...
  AttackSpeed_Reload = {
    ...
    Name = "Attr_AttackSpeed_Reload_Name",
    ShowInInspector = true,
    SortIndex1 = 21,
    SortIndex2 = 21,
    SortIndex3 = 21,
  ...
  AttackSpeed_SlideAttack = {
    ...
    Name = "Attr_AttackSpeed_SlideAttack_Name",
    ShowInInspector = true,
    SortIndex1 = 20.5,
    SortIndex2 = 20.5,
    SortIndex3 = 20.5,
  ...
  DamageRate = {
    Id = "DamageRate",
    IsPercent = true,
    Name = "Attr_DamageRate_Normal_Nmae",
    ShowInInspector = true,
    SortIndex1 = 9.5,
    SortIndex2 = 9.5,
    SortIndex3 = 9.5,
  ...
  MagazineCapacity = {
    Id = "MagazineCapacity",
    Name = "Attr_MagazineCapacity_Name",
    ShowInInspector = true,
    SortIndex1 = 27,
    SortIndex2 = 27,
    SortIndex3 = 27,
  ...
  SkillEfficiency = {
    ...
    AttrLimit = "MaxSkillEfficiency",
    Id = "SkillEfficiency",
    IsPercent = true,
    Name = "Attr_SkillEfficiency_Name",
    ShowInInspector = true,
    SortIndex1 = 17,
    SortIndex2 = 17,
    SortIndex3 = 17,
  ...
  SkillRange = {
    ...
    AttrLimit = "MaxSkillRange",
    Id = "SkillRange",
    IsPercent = true,
    Name = "Attr_SkillRange_Name",
    ShowInInspector = true,
    SortIndex1 = 15,
    SortIndex2 = 15,
    SortIndex3 = 15,
  ...
  SkillSustain = {
    ...
    AttrLimit = "MaxSkillSustain",
    Id = "SkillSustain",
    IsPercent = true,
    Name = "Attr_SkillSustain_Name",
    ShowInInspector = true,
    SortIndex1 = 16,
    SortIndex2 = 16,
    SortIndex3 = 16,
  ...
  TriggerProbModifierValue = {
    ...
    IsPercent = true,
    Name = "Attr_TriggerProbModifierValue_Name",
    ShowInInspector = true,
    SortIndex1 = 22.5,
    SortIndex2 = 22.5,
    SortIndex3 = 22.5,
  ...
  TriggerProbability = {
    ...
    IsPercent = true,
    Name = "Attr_TriggerProbability_Name",
    ShowInInspector = true,
    SortIndex1 = 22,
    SortIndex2 = 22,
    SortIndex3 = 22,
