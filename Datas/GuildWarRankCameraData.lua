-- filename: @C:/Pack/Branch/geili11\Content/Script/Datas\GuildWarRankCameraData.lua
-- version: lua54
-- line: [0, 0] id: 0
local r0_0 = {
  RT_1 = {
...
local r3_0 = "GuildWarRankCameraData"
local r4_0 = {}
r4_0.Char_Boy = {
  CameraFocal = 38.6,
  CameraName = "Char_Boy",
