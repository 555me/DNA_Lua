-- filename: @C:/Pack/Branch/geili11\Content/Script/Datas\TextMap.lua
-- version: lua54
-- line: [0, 0] id: 0
...
return setmetatable({}, {
  __index = function(r0_1, r1_1)
    -- line: [7, 9] id: 1
    return DataMgr["TextMap_" .. r1_0.SystemLanguage][r1_1]
  end,
  __pairs = function(r0_2)
    -- line: [10, 18] id: 2
    local r1_2 = DataMgr["TextMap_" .. r1_0.SystemLanguage]
