-- filename: @C:/Pack/Branch/geili11\Content/Script/Datas\PartyNpc.lua
-- version: lua54
-- line: [0, 0] id: 0
local r0_0 = {
  RT_1 = {
...
r4_0[1501] = {
  AvatarIconPath = "Texture2D\'/Game/UI/Texture/Dynamic/Image/Head/Avatar_Icon/T_Icon_Baonu.T_Icon_Baonu\'",
  CameraBlendCurve = "easeInOutQuad",
  CharId = 1501,
  MainCameraName = "Baonu_Main",
  NpcSeatKey = "3.0",
  PartyTopicList = r0_0.RT_1,
  ReverseActionId = "Sit03_End",
  SeatPointName = "EntrySeatPoint_Baonu",
  SwitchCameraName = "Baonu_Main",
  TalkActionId = "Sit03_Start",
  TopicCameraName = "Baonu_Topic",
...
r4_0[1503] = {
  AvatarIconPath = "Texture2D\'/Game/UI/Texture/Dynamic/Image/Head/Avatar_Icon/T_Icon_Kezhou.T_Icon_Kezhou\'",
  CameraBlendCurve = "easeInOutQuad",
  CharId = 1503,
  ...
  ReverseActionId = "Sit03_End",
  SeatPointName = "EntrySeatPoint_Kezhou",
  SwitchCameraName = "Kezhou_Main",
  TalkActionId = "Sit03_Start",
  TopicCameraName = "Kezhou_Topic",
  TopicSeatPointName = "SeatPoint_Man",
  TopicUnitId = 91503,
  UnitId = 991503,
  bEnableParty = true,
