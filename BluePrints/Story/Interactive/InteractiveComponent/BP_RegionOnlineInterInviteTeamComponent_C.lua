-- filename: @C:/Pack/Branch/geili11\Content/Script/BluePrints\Story\Interactive\InteractiveComponent\BP_RegionOnlineInterInviteTeamComponent_C.lua
-- version: lua54
-- line: [0, 0] id: 0
require("UnLua")
require("DataMgr")
...
function r1_0.BtnClicked(r0_6, r1_6, r2_6)
  ...
  if r3_6 then
    ...
    if r6_6 and r6_6.Uid then
      TeamController:SendTeamInvite(r6_6.Uid)
    end
  end
end
